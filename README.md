...
Версия: **1.0.0** · Дата: 2026-05-18 · Лицензия: внутреннее использование ВМедА

> Релиз v1.0.0 — первый production-ready релиз для развёртывания в LAN ВМедА.
> Гайды по ролям: `docs/DEPLOY.md` (для IT), `docs/ADMIN_GUIDE.md`,
> `docs/TEACHER_GUIDE.md`, `docs/STUDENT_GUIDE.md`.
> Security audit: `docs/SECURITY_AUDIT_v1.0.0.md` (OWASP §B.2.3 — 13/13 pass).
